    ...
    return(
        <div>
            <div className="bootcamp-content">
                ...
                <p>With no experience coding prior to the boot camp I was drawn to the tech industry as not only can you build projects from the ground up but you can do so in a stable career, so when the chance to join School of Code for free came up I jumped at the chance.</p>
            </div>
            <Footer/>
        </div>
    )
